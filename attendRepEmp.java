...
public class attendRepEmp extends JFrame 
{
  String[] colhead={"EMPLOYEE ID","DEPARTMENT ID","EMPLOYEE NAME","DAYS PRESENT"};
...
public class dispallListener implements ActionListener
{
			...
			try
    {
		...
		int i=0;
        rs=statement.executeQuery("select * from attendence where eid='"+loginform.usr+"'"); 
        while(rs.next())
        {
...
public class setupListener implements ActionListener
{
 ...
 {
         attendRepEmp s=new  attendRepEmp();
 }

...
public class generationRep extends JFrame 
{
  String[] colhead={"STATION ID","STATION NAME","MONTHLY GENERATION"};
...
public class setupListener implements ActionListener
{
 ...
 {
         generationRep s=new  generationRep();
 }

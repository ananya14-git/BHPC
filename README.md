...
Automated manual Excel-based processes for multiple power distribution companies (North Bihar and South Bihar Power Distribution), centralizing data management and reducing reporting errors.
Designed intuitive GUI interfaces for data entry, validation, and report generation, deployed on Windows 8.1 systems across the organization.

...
public class distRep extends JFrame 
{
  String[] colhead={"EMPLOYEE ID","DEPARTMENT ID","EMPLOYEE NAME","DESIGNATION","SALARY"};
 ...
 public distRep()
 {
        ...
        title =new JLabel("DISTRIBUTION REPORT");
        ...
        dispall=new JButton("SHOW DISTRIBUTION DETAILS");
...
public class dispallListener implements ActionListener
{
              	...
              	try
    {
		...
		int i=0;
        rs=statement.executeQuery("select * from distribution"); 
        while(rs.next())
        {

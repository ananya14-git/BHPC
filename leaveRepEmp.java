...
public class leaveRepEmp extends JFrame 
{
  String[] colhead={"EMPLOYEE ID","LEAVE ID","STARTING DATE ","ENDING DATE","NO OF DAYS"}; 
 ...
 public leaveRepEmp()
 {
        ...
        dispall=new JButton("SHOW LEAVE DETAILS");
...
public class dispallListener implements ActionListener
{
				...
				try
    {
		...
		int i=0;
        rs=statement.executeQuery("select * from leave where eid='"+loginform.usr+"'"); 
        while(rs.next())
        {

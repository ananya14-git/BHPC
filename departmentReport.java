...
public class departmentReport extends JFrame 
{
  String[] colhead={"Department Code","Department name","Department manager"};
 ...
 public departmentReport()
 {
        ...
        title =new JLabel("Department Report ");
...
public class setupListener implements ActionListener
{
 ...
 {
         departmentReport s=new  departmentReport();
 }

...
import java.awt.*;
import java.sql.*;
class generationOption extends JPanel implements ActionListener
{ 
JLabel lblTitle;
JButton btnIns,btnUp;
...
{ 
 ...
 Image ins=new ImageIcon("fotos/tuser.jpg").getImage().getScaledInstance(50,50,Image.SCALE_SMOOTH);
  Image up=new ImageIcon("fotos/update.jpeg").getImage().getScaledInstance(50,50,Image.SCALE_SMOOTH);
   lblTitle=new JLabel("GENERATION ");
  btnIns=new JButton("Generation Master",new ImageIcon(ins));
  btnUp=new JButton("Edit Generation Master",new ImageIcon(up));
  ...
  btnUp.setBounds(550,250,270,50);
  ...
  if(e.getSource()==btnUp)
  {
   ...
   /* public static void main(String arg[])
     {generationOption oo=new generationOption();}*/
}